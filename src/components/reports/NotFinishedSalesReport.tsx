...
import { IDateFilters, IReportsFullFilters } from "../../types/types";
import useNotFinishedSalesReportHook from "../../customHooks/reportsHook/useNotFinishedSalesReportHook";
...
const NotFinishedSalesReport: FC = () => {
  ...
  const report = useNotFinishedSalesReportHook(allFilters);
    ...
    <div className="flex flex-col h-screen w-full">
      <div className="flex justify-between w-full">
        <span className="text-2xl px-6 py-2">
          Izveštaj o svim stanovima za koje je jedan klijent zainteresovan
        </span>
      </div>
...
export default NotFinishedSalesReport;
